...
const PaymentPrint = forwardRef<HTMLDivElement, PaymentPrintProps>(({ paymentData, currentPage = 1, totalPages = 1 }, ref) => {
        ...
        >
            ...
            <Box sx={{ mb: 3 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                    <Typography variant="body2" sx={{ fontSize: '11px' }}>
                        No: <strong>{paymentData.payment_id}</strong>
                    </Typography>
                    <Typography variant="body2" sx={{ fontSize: '11px' }}>
                        Dated: <strong>{formatDate(paymentData.payment_date)}</strong>
                    </Typography>
                </Box>
                    ...
                    <Box sx={{ p: 2, borderRight: '1px solid #000', minHeight: '250px' }}>
                        ...
                        <Box sx={{ mt: 15 }}>
                            ...
                            <Typography variant="body2" sx={{ fontSize: '11px', pl: 2, color: '#d32f2f' }}>
                                {paymentData.mode_of_payment_paid}
                            </Typography>
                            ...
                            <Typography variant="body2" sx={{ fontSize: '11px', pl: 2, color: '#d32f2f' }}>
                                * {convertAmountToWords(paymentData.amount)}
                            </Typography>
                        </Box>
                    </Box>
            ...
            >
                <Typography variant="caption" sx={{ fontSize: '8px', color: '#666' }}>
                    https://manipalsociety.in/Banking/Print/handler.js?name=PaymentVoucher&payment={paymentData.payment_id}
                </Typography>
...
PaymentPrint.displayName = 'PaymentPrint';
