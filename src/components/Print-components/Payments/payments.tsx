...
interface PaymentsTablePrintProps {
    payments: PaymentData[];
    dateRange?: string;
}

const PaymentsTablePrint = forwardRef<HTMLDivElement, PaymentsTablePrintProps>(({ payments, dateRange }, ref) => {
            ...
            >
                <TableHead>
                    <TableRow sx={{ backgroundColor: '#f3f4f6' }}>
                        ...
                        <TableCell sx={{ fontWeight: 700, width: '18%' }}>Paid To</TableCell>
                ...
                <TableBody>
                    {payments.map((payment, index) => (
                        <TableRow key={payment.payment_id}>
                            ...
                            <TableCell sx={{ fontWeight: 600 }}>{payment.payment_id}</TableCell>
                            <TableCell>{formatDate(payment.payment_date)}</TableCell>
                            <TableCell>{payment.paid_to}</TableCell>
...
PaymentsTablePrint.displayName = 'PaymentsTablePrint';

export default PaymentsTablePrint;
